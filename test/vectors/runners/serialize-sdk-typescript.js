#!/usr/bin/env node
// SDK-level serialization runner for TypeScript MCP SDK.
// The TypeScript SDK uses JSON.stringify with no custom configuration
// (the reference implementation). This runner is identical to the stdlib
// runner by design — it exists so --layer sdk is self-contained and the
// TS-as-reference baseline is explicit.
const tests = [
  ...
  { test: "unicode_nfd", result: JSON.stringify("café") },
